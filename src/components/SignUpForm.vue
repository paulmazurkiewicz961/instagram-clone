      ...
      <div class="col-6 q-pt-xs q-pb-lg">
        <q-card square class="shadow-1">
          ...
          <q-card-section class="text-center text-blue-10 text-weight-bold">
            <q-btn icon="fa-brands fa-square-facebook" label="Log in with Facebook" no-caps flat/>            
          </q-card-section>
          </div>
          
          <q-card-section class="text-center text-caption text-blue-10 text-weight-lighter">
            <q-btn  class="text-center text-caption text-blue-10 text-weight-lighter" label="Forgot password?" no-caps flat/>
          </q-card-section>
        </q-card>
        ...
        <q-card square class="q-mt-md">
          <div class="row justify-center items-center">
            ...
            <q-card-section>  
            <q-btn label="Log In" flat size="12px" color="blue" no-caps @click="$emit('switchPage')"/>    
            </q-card-section>
          </div>
        </q-card>
